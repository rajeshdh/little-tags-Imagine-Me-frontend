    ...
    <div className="min-h-3/4 flex flex-col items-center justify-center bg-sp-white">
      <div className="flex flex-col bg-white shadow-lg px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
        ...
        >
          ...
          <span>
            <FormattedMessage id={facebookButtonText} />
          </span>
        </button>
        ...
        <div className="mt-10">
          <form onSubmit={onSubmit}>
            ...
            <div className="flex w-full">
              <button
                type="submit"
                className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-sp-btn-primary hover:bg-sp-btn-primary-dark rounded py-2 w-full transition duration-150 ease-in"
              >
