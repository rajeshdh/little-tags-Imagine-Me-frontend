...
export default function CategoryCarouselCard({ title, image }) {
    return <div className="relative rounded-full bg-center bg-contain bg-no-repeat shadow-md w-16 h-16 mr-5 sm:rounded sm:w-48 sm:h-56 sm:bg-cover transform hover:scale-110 my-4"
