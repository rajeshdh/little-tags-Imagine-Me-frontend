...
export default function MainCarouselCard({ title, description, image }) {
  return (
    <div className="flex flex-row-reverse h-full relative">
      <div
        className="w-full relative bg-top bg-cover bg-no-repeat lg:w-2/4"
        style={{ backgroundImage: `url(${image})` }}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-100 opacity-50 lg:hidden" />
      </div>
