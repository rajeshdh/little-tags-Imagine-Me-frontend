	...
	return (
		<div className="min-h-3/4 flex flex-col items-center justify-center bg-sp-white">
			<div className="flex flex-col bg-white shadow-lg px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
				<div className="font-medium self-center text-xl sm:text-2xl uppercase text-gray-800">	<FormattedMessage id="registerNow" /></div>
				<button 
				...
				text-sm bg-blue-800 hover:bg-blue-900 text-white focus:outline-none focus:shadow-outline">
					...
					<span>	<FormattedMessage id="signUPWithFacebook" /></span>
				</button>
				<div className="relative mt-10 h-px bg-gray-300">
					<div className="absolute left-0 top-0 flex justify-center w-full -mt-2">
						<span className="bg-white px-4 text-xs text-gray-500 uppercase">

							<FormattedMessage id="signUpWithEmail" />
							</span>
					</div>
				</div>
				<div className="mt-10">
					<form onSubmit={onSubmit}>
						...
						<div className="flex w-full">
							<button type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-sp-btn-primary hover:bg-sp-btn-primary-dark rounded py-2 w-full transition duration-150 ease-in">
								<span className="mr-2 uppercase"><FormattedMessage id="register" /></span>
								<span>
									<svg className="h-6 w-6" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
				...
				<div className="flex justify-center items-center mt-6">
					<Link to="/login" className="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
						...
						<span className="ml-2"><FormattedMessage id="signInInstead" /></span>
					</Link>
				</div>
			</div>
		</div>
