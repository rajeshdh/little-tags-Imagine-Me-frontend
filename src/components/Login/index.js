    ...
    <div className="w-full h-screen flex flex-col justify-center align-center bg-sp-white">
      <div className="flex mx-auto max-w-6xl h-1/2 shadow-2xl justify-center align-center rounded-lg overflow-hidden">
        <div className="flex flex-col w-1/2 p-5 align-center justify-center bg-white">
          ...
          <FormattedMessage id="loginToStart" />
					</p>
        </div>
        <form
          onSubmit={onSubmit}
        ...
        >
          ...
          <button
            type="submit"
            className="py-4 px-2 active:bg-gray-800 bg-sp-btn-primary hover:bg-sp-btn-primary-dark text-white w-5/12 self-center mt-2 hover:shadow-2xl rounded-md"
          >
          ...
          >
            <FormattedMessage id="signUpInstead" />
					</Link>
        </form>
      </div>
    </div>
